    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-foreground mb-4">Top Rated Vendors</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Shop with confidence from our highest-rated vendors who consistently deliver quality products and excellent
            service
          </p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="text-center">
                  <div className="relative mb-4">
                    ...
                    />
                    {vendor.verified && (
                      <Badge className="absolute -top-1 -right-1 bg-primary text-primary-foreground">✓</Badge>
                    )}
                  </div>
                  ...
                  <div className="text-sm text-muted-foreground mb-4">{vendor.products} Products</div>
